# ==========================================================
#  08_run_bb_tg_ctx_stgp_ctx_dial_stz.R
# ==========================================================
...
# ---------- paths ----------
fit_name_cd     <- "08_bb_tg_ctx_stgp_ctx_dial_stz"
...
build_dialect_augment <- function(dat_base, t0, scale_years) {
  ...
  # Time-standardize with the same parameters as dat_base so that
  # rows correspond (standardization does not change row order).
